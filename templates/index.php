        ...
        <div class="top_menu row m0">
            <div class="container">
                <div class="float-right">
                    <a class="dn_btn" href="mailto:atendimento@metalbr.com.br">
                        <i class="fas fa-envelope"></i>
                        atendimento@metalbr.com.br
                    </a>
                    <a class="dn_btn" href="tel:+552649-3882">
    ...
    <section class="about-area pt-5 pb-4">
        ...
        <div class="row align-items-lg-center">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <h2 class="section-title mb-3">Bem-vindo à Metal BR</h2>
